...
User Validate the Respond Body
    IF    ${real_time_weather_request_status_code} == 200
          ...
          ${location_localtime}    Get Value From Json    ${real_time_weather_respond}    $.location.localtime
